defmodule Erflow.Core.Task do
  ...
  schema "tasks" do
    ...
    many_to_many :parent, Erflow.Core.Task, join_through: "tasks_tasks", join_keys: [child_id: :task_id, parent_id: :task_id], on_replace: :delete
    many_to_many :child, Erflow.Core.Task, join_through: "tasks_tasks", join_keys: [parent_id: :task_id, child_id: :task_id], on_replace: :delete
  end
