...
#       dag = dag_fixture()
#       assert Model.list_dags() == [dag]
#     end

#     test "get_dag!/1 returns the dag with given id" do
#       dag = dag_fixture()
#       assert Model.get_dag!(dag.id) == dag
#     end

#     test "create_dag/1 with valid data creates a dag" do
#       assert {:ok, %Dag{} = dag} = Model.create_dag(@valid_attrs)
...
#       assert {:error, %Ecto.Changeset{}} = Model.create_dag(@invalid_attrs)
#     end

#     test "update_dag/2 with valid data updates the dag" do
#       dag = dag_fixture()
#       assert {:ok, %Dag{} = dag} = Model.update_dag(dag, @update_attrs)
...
#       dag = dag_fixture()
#       assert {:error, %Ecto.Changeset{}} = Model.update_dag(dag, @invalid_attrs)
#       assert dag == Model.get_dag!(dag.id)
#     end

#     test "delete_dag/1 deletes the dag" do
#       dag = dag_fixture()
#       assert {:ok, %Dag{}} = Model.delete_dag(dag)
#       assert_raise Ecto.NoResultsError, fn -> Model.get_dag!(dag.id) end
#     end

#     test "change_dag/1 returns a dag changeset" do
#       dag = dag_fixture()
#       assert %Ecto.Changeset{} = Model.change_dag(dag)
#     end
#   end
...
#       assert Model.list_relationships() == [relationship]
#     end

#     test "get_relationship!/1 returns the relationship with given id" do
#       relationship = relationship_fixture()
#       assert Model.get_relationship!(relationship.id) == relationship
#     end

#     test "create_relationship/1 with valid data creates a relationship" do
#       assert {:ok, %Relationship{} = relationship} = Model.create_relationship(@valid_attrs)
#     end

#     test "create_relationship/1 with invalid data returns error changeset" do
#       assert {:error, %Ecto.Changeset{}} = Model.create_relationship(@invalid_attrs)
#     end

#     test "update_relationship/2 with valid data updates the relationship" do
#       relationship = relationship_fixture()
#       assert {:ok, %Relationship{} = relationship} = Model.update_relationship(relationship, @update_attrs)
#     end

#     test "update_relationship/2 with invalid data returns error changeset" do
#       relationship = relationship_fixture()
#       assert {:error, %Ecto.Changeset{}} = Model.update_relationship(relationship, @invalid_attrs)
#       assert relationship == Model.get_relationship!(relationship.id)
#     end

#     test "delete_relationship/1 deletes the relationship" do
#       relationship = relationship_fixture()
#       assert {:ok, %Relationship{}} = Model.delete_relationship(relationship)
#       assert_raise Ecto.NoResultsError, fn -> Model.get_relationship!(relationship.id) end
#     end

#     test "change_relationship/1 returns a relationship changeset" do
#       relationship = relationship_fixture()
#       assert %Ecto.Changeset{} = Model.change_relationship(relationship)
#     end
#   end
# end
